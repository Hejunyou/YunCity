...
//  Copyright (c) 2015年 何俊佑. All rights reserved.
...
//    [bar setBackgroundImage:[UIImage imageNamed:@"recomend_btn_Collected"] forBarMetrics:UIBarMetricsDefault];
    [bar setBarTintColor:WNXGolbalskyblue];
