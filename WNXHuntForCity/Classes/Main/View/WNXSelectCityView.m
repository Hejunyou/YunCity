...
+ (instancetype)selectCityViewWithCictyButton:(WNXCityButton *)cicytBtn
{
    ...
    NSMutableArray *cictys = [NSMutableArray arrayWithArray:@[@"南宁", @"上海", @"广州", @"深圳"]];
...
- (void)setButton:(WNXMenuButton *)btn index:(int)index
{
    ...
    UIView *blackLine = [[UIView alloc] initWithFrame:CGRectMake(btnX + margin,index * btnFY, btnW - 2 * margin, 1)];
