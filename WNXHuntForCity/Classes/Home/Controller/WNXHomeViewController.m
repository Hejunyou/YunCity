...
- (void)setUpNavigationItem
{
    ...
    //深天蓝色
    [titleV setTintColor:WNXColor(0, 191, 255)];
...
{
    //设置背景色
    [self.view setBackgroundColor:WNXGolbalskyblue];
...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"recomend_btn_Collected"] forBarMetrics:UIBarMetricsDefault];
    [self.navigationController.navigationBar setBackgroundColor:WNXGolbalskyblue];
